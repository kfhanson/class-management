...
@section('css')
    <link rel="stylesheet" href="{{ URL::asset('plugins/RWD-Table-Patterns/dist/css/rwd-table.min.css') }}" type="text/css" media="screen">
@endsection
...
@section('button')
    <a href="check" class="btn btn-success btn-sm btn-flat"><i class="mdi mdi-plus"></i>Add New</a>
@endsection
                ...
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="datatable-buttons" class="table table-hover table-striped table-bordereddt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
